...
contract FastJPEGFactoryTest is Test {
    ...
    function testFactory() public view {
        assertNotEq(factory.feeToSetter(), address(0), "Factory feeToSetter should not be zero");
    }

    function testRouter() public view {
        assertEq(address(router.WETH()), address(weth), "Wrapped WETH should be correct");
    }
    ...
    function testBuy() public {
        ...
        assertEq(token.balanceOf(feeTo), 0, "Fee recipient should have 0 FJPG tokens");
